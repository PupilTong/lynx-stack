...
export interface InitOutput {
  ...
  readonly templatemanager_add_element_template: (a: number, b: number, c: number, d: any) => [number, number];
  readonly templatemanager_add_style_info: (a: number, b: number, c: number, d: any, e: any) => [number, number];
  readonly templatemanager_has_element_template: (a: number, b: number, c: number) => number;

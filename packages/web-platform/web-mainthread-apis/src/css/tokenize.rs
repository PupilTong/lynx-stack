...
pub fn consume_numeric_token(source: &Vec<u16>, offset: &mut usize, token_type: &mut u16) {
...
pub fn consume_ident_like_token(source: &Vec<u16>, offset: &mut usize, token_type: &mut u16) {
...
pub fn consume_url_token(source: &Vec<u16>, offset: &mut usize, token_type: &mut u16) {
  let source_length = source.len();
  ...
  *offset = find_white_space_end(source, *offset);
  ...
  while *offset < source_length {
    ...
    match char_code_category!(code as usize) {
      ...
      0x0022 | 0x0027 | 0x0028 | char_code_definitions::NAME_START_CATEGORY => {
...
pub fn tokenize(source: &Vec<u16>, on_token: &dyn Fn(u16, usize, usize)) {
  let source_length = source.len();
